...
public class ControlPanel : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        _inputWhy = _panel.transform.Find("InputWhy").GetComponent<InputField>();
    }
    ...
    {
        _userInfo = new UserInfo(_inputName.text, _inputUse.text, _inputWhy.text ,Time.time.ToString(), _slcManager.ElementStates);
